...
export class Orders {
  ...
  @Column("int", { name: "user_id", nullable: true }) userId!: number | null;
  @Column("int", { name: "business_id", nullable: true }) businessId!: number | null;
  ...
  @Column("decimal", { name: "delivery_latitude", nullable: true, precision: 10, scale: 8 }) deliveryLatitude!: string | null;
  @Column("decimal", { name: "delivery_longitude", nullable: true, precision: 11, scale: 8 }) deliveryLongitude!: string | null;
  @Column("varchar", { name: "delivery_city", nullable: true, length: 120 }) deliveryCity!: string | null;
  @Column("varchar", { name: "delivery_postal_code", nullable: true, length: 20 }) deliveryPostalCode!: string | null;
  @Column("text", { name: "order_notes", nullable: true }) orderNotes!: string | null;
  @Column("int", { name: "delivery_address_id", nullable: true }) deliveryAddressId!: number | null;

  @ManyToOne(() => DeliveryPersons, (deliveryPersons) => deliveryPersons.orders, { onDelete: "RESTRICT", onUpdate: "RESTRICT" })
  @JoinColumn([{ name: "delivery_id", referencedColumnName: "deliveryId" }]) delivery!: DeliveryPersons;
  @ManyToOne(() => UserAddresses, (userAddresses) => userAddresses.orders, { onDelete: "RESTRICT", onUpdate: "RESTRICT" })
  @JoinColumn([{ name: "delivery_address_id", referencedColumnName: "addressId" }]) deliveryAddress_2!: UserAddresses;
  @ManyToOne(() => Users, (users) => users.orders, { onDelete: "RESTRICT", onUpdate: "RESTRICT" })
  @JoinColumn([{ name: "user_id", referencedColumnName: "userId" }]) user!: Users;
  @ManyToOne(() => Business, (business) => business.orders, { onDelete: "RESTRICT", onUpdate: "RESTRICT" })
  @JoinColumn([{ name: "business_id", referencedColumnName: "businessId" }]) business!: Business;
  @OneToMany(() => OrderDetails, (orderDetails) => orderDetails.order) orderDetails!: OrderDetails[];
