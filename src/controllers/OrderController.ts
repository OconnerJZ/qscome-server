...
export class OrderController {
    ...
    async getById(req: Request, res: Response) {
        try {
            ...
            const order = await this.orderRepo.findOne({
                ...
                relations: ["user", "business", "orderDetails", "orderDetails.menu", "orderStatusHistories"]
            });
    ...
    async getByUser(req: Request, res: Response) {
        try {
            ...
            const orders = await this.orderRepo.find({
                ...
                relations: ["business", "orderDetails", "orderDetails.menu", "orderStatusHistories"],
                order: { createdAt: "DESC" }
            });
    ...
    async getByBusiness(req: Request, res: Response) {
        try {
            ...
            const orders = await this.orderRepo.find({
                ...
                relations: ["user", "orderDetails", "orderDetails.menu", "orderStatusHistories"],
                order: { createdAt: "DESC" }
            });
    ...
    async updateStatus(req: Request, res: Response) {
        try {
            ...
            const validStatuses = ["pending", "accepted", "preparing", "ready", "in_delivery", "completed", "cancelled"];
