...
export const ORDER_STATUSES = ["pending", "accepted", "preparing", "ready", "in_delivery", "completed", "cancelled"] as const;
export type OrderStatus = (typeof ORDER_STATUSES)[number];
const STATUS_LABELS: Record<string, string> = { pending: "Pendiente", accepted: "Aceptada", preparing: "Preparando", ready: "Lista", in_delivery: "En Camino", completed: "Completada", cancelled: "Cancelada" };
